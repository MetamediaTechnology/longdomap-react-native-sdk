...
export default class MapView extends Component {
    ...
    <html lang="en">
      ...
      <body onload="init();">
        ...
        return (_jsx(View, { style: styles.container, children: _jsx(WebView, { ref: (r) => (this.#web = r), originWhitelist: ['*'], source: {
                    html: html,
                    baseUrl: this.#baseUrl,
                }, style: {
                    height: windowHeight,
                    width: windowWidth,
                }, onMessage: (e) => this.#onMessage(e.nativeEvent.data), onShouldStartLoadWithRequest: (e) => e.url === this.#baseUrl }) }));
    }
    call(method, ...args) {
